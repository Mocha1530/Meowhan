return {
    ["Cosmetic Items"] = {
        ...
        ["Red Pottery"] = {
            CosmeticName = "Red Pottery",
            StockAmount = {1, 3},
            Price = 800000,
            PurchaseID = 3290144998,
            FallbackPrice = 29
        },
        ["White Pottery"] = {
            CosmeticName = "White Pottery",
            StockAmount = {1, 3},
            Price = 800000,
            PurchaseID = 3290145014,
            FallbackPrice = 29
        },
        ["Wood Pile"] = {
        ...
        ["Viney Beam"] = {
            CosmeticName = "Viney Beam",
            StockAmount = {1, 1},
            Price = 1300000,
            PurchaseID = 3290145026,
            FallbackPrice = 59
        },
        ["Water Trough"] = {
        ...
        ["White Bench"] = {
            CosmeticName = "White Bench",
            StockAmount = {1, 1},
            Price = 1000000,
            PurchaseID = 3290144996,
            FallbackPrice = 59
        },
        ["Wood Fence"] = {
        ...
        ["Bamboo Wind Chime"] = {
            CosmeticName = "Bamboo Wind Chime",
            StockAmount = {1, 1},
            Price = 11750000,
            PurchaseID = 3290112781,
            FallbackPrice = 119
        },
        ["Metal Wind Chime"] = {
            CosmeticName = "Metal Wind Chime",
            StockAmount = {1, 1},
            Price = 11750000,
            PurchaseID = 3290112884,
            FallbackPrice = 119
        },
        ["Bird Bath"] = {
        ...
        Clothesline = {
            CosmeticName = "Clothesline",
            StockAmount = {1, 1},
            Price = 11800000,
            PurchaseID = 3290145013,
            FallbackPrice = 119
        },
        ["Cooking Pot"] = {
        ...
        ["Blue Well"] = {
            CosmeticName = "Blue Well",
            StockAmount = {1, 1},
            Price = 60000000,
            PurchaseID = 3290145027,
            FallbackPrice = 189
        },
        ["Brown Well"] = {
            CosmeticName = "Brown Well",
            StockAmount = {1, 1},
            Price = 60000000,
            PurchaseID = 3290113294,
            FallbackPrice = 189
        },
        ["Red Well"] = {
            CosmeticName = "Red Well",
            StockAmount = {1, 1},
            Price = 60000000,
            PurchaseID = 3290115132,
            FallbackPrice = 189
        },
        ["Green Tractor"] = {
        ...
        ["Ring Walkway"] = {
            CosmeticName = "Ring Walkway",
            StockAmount = {1, 1},
            Price = 55000000,
            PurchaseID = 3290145033,
            FallbackPrice = 189
        },
        ["Viney Ring Walkway"] = {
            CosmeticName = "Viney Ring Walkway",
            StockAmount = {1, 1},
            Price = 55200000,
            PurchaseID = 3290145045,
            FallbackPrice = 189
        },
        ["Large Wood Arbour"] = {
        ...
        ["Cooking Kit"] = {
            CosmeticName = "Cooking Kit",
            StockAmount = {1, 1},
            Price = 1000000,
            FallbackPrice = 99,
            ShecklesPurchaseOnly = true,
            PermanentUntilPurchase = true,
            LayoutOrder = -1,
            LifetimeLimit = 1
        }
    },
    ["Cosmetic Crates"] = {
        ...
        ["Beach Crate"] = {
            CrateName = "Beach Crate",
            CrateRarity = "Legendary",
            StockChance = 3,
            Price = 88000000,
            PurchaseID = 3312017021,
            FallbackPrice = 179
        },
        ["Summer Fun Crate"] = {
            CrateName = "Summer Fun Crate",
            CrateRarity = "Legendary",
            StockChance = 20,
            Price = 88000000,
            PurchaseID = 3312016819,
            FallbackPrice = 179
        },
        ["Farmers Gnome Crate"] = {
